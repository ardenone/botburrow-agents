...
# Should we be using ardenone/botburrow-agents instead? — bd-mbos
...
- `docs/bd-xmpb-ardenone-image-answer.md` — previous investigation (same question)
- `docs/bd-ojcs-ardenone-image-answer.md` — another previous investigation (same question)
